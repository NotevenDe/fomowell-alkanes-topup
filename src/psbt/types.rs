...
impl InputSignatureType {
    ...
    pub fn from_str(sig_type: &str) -> Result<Self, String> {
        match sig_type.to_lowercase().as_str() {
            ...
            "ecdsa_all_anyonecanpay" => Ok(InputSignatureType::Ecdsa(
                EcdsaSighashType::AllPlusAnyoneCanPay,
            )),
            "ecdsa_none_anyonecanpay" => Ok(InputSignatureType::Ecdsa(
                EcdsaSighashType::NonePlusAnyoneCanPay,
            )),
            "ecdsa_single_anyonecanpay" => Ok(InputSignatureType::Ecdsa(
            ...
            "taproot_all_anyonecanpay" => Ok(InputSignatureType::Taproot(
                TapSighashType::AllPlusAnyoneCanPay,
            )),
            "taproot_none_anyonecanpay" => Ok(InputSignatureType::Taproot(
                TapSighashType::NonePlusAnyoneCanPay,
            )),
            "taproot_single_anyonecanpay" => Ok(InputSignatureType::Taproot(
